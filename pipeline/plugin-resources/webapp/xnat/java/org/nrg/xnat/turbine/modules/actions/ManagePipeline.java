...
//			String pipeline_path = (String)context.get("pipelinePath");
		    ...
		    String subject = item.getStringProperty("subject_id");
		    xnatPipelineLauncher.setParameter("experiment", exptLabel);
		    xnatPipelineLauncher.setParameter("project", project);
		    xnatPipelineLauncher.setParameter("subject", subject);
